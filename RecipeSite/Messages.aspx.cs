    ...
    public partial class Messages : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Page.IsPostBack == false)
            {
                ...
                SqlCommand com = new SqlCommand("select * from TBL_MESSAGES", con.connection());
            ...
            if (operation == "delete")
            {
                SqlCommand com2 = new SqlCommand("Delete from TBL_MESSAGES where ID=@id", con.connection());
